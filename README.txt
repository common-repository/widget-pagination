...
* Optimisation: when saving settings, invalid settings values now cause displaying of error messages
* Optimisation: on plugins settings page, invalid values are now highlighted with red
